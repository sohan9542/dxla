...
<Trending />
    <>
      ...
      <div className=" w-full">
      <h1 className=" text-4xl  text-white pt-5 pb-5">DXLApad</h1>
        <div className=" w-full flex items-center justify-center">
          <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
            ...
            >
              <Tab label="All DXLApad" {...a11yProps(0)} />
              <Tab label="My DXLApad" {...a11yProps(1)} />
              <Tab label="My Contributions" {...a11yProps(2)} />
            </Tabs>
          </Box>
        </div>
